...
-- CreateIndex
CREATE UNIQUE INDEX "ArticleStatus_name_key" ON "ArticleStatus"("name");

-- CreateIndex
CREATE UNIQUE INDEX "ArticleStatus_slug_key" ON "ArticleStatus"("slug");
...
-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "ArticleStatus"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_langId_fkey" FOREIGN KEY ("langId") REFERENCES "Language"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "article_tags" ADD CONSTRAINT "article_tags_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE CASCADE ON UPDATE CASCADE;
